...
import 'package:flutter_application/widgets/fields/MultiSelectionField.dart';
...
class MultiSelectionFormField<T> extends FormField<List<T>> {
  ...
  @override
  FormFieldState<List<T>> createState() => _MultiSelectionFormFieldState<T>();
}

class _MultiSelectionFormFieldState<T> extends FormFieldState<List<T>> {
  @override
  MultiSelectionFormField<T> get widget =>
      super.widget as MultiSelectionFormField<T>;
